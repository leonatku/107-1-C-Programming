...
7. Rectangle 
8. Vertical Triangle 
9. 3. Exit => 2 Enter height and type: 5 2 * ** * * * * ***** Main Menu 1. Rectangle 2. Vertical Triangle 3. Exit => 2 Enter height and type: 5 3 ***** * * * * ** * Main Menu 1. Rectangle 2. Vertical Triangle 3. Exit => 2 Enter height and type: 5 4 ***** * * * * ** * Main Menu 1. Rectangle 2. Vertical Triangle 3. Exit => 3
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTAxODE5NzcsMTczNjA2MjE3NiwzMD
